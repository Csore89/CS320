...
public class Contact {
    ...
    public Contact(String contactId, String firstName, String lastName, String phone, String address) {
        ...
        if(firstName == null || firstName.length() > 10) throw new IllegalArgumentException("Invalid firstName");
        if(lastName == null || lastName.length() > 10) throw new IllegalArgumentException("Invalid lastName");
